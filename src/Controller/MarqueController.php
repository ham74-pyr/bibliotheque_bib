...
{
    /**
     * @Route("/afficher", name="app_marque_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/ajouter", name="app_marque_new", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/modifier/{id}", name="app_marque_edit", methods={"GET", "POST"})
     */
